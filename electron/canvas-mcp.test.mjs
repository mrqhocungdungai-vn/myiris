...
// Wiring-shape coverage (design.md D6/5.1/5.2, task 7.4): both the resident
// session's options.mcpServers entry (stateful-session.test.mjs asserts it flows
// through unmodified) and the stateless run's --mcp-config JSON (main.mjs wraps this same record
