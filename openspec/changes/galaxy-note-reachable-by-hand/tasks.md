...
- [ ] 10.23 Manual pass on the completed vocabulary: whether reeling in on a locked note feels right, and whether a fist meant to TURN the view is disrupted by the other hand resting open in frame (D26's named cost) whether aiming at a note and spreading actually arrives at it, whether the far side of the sphere is still reachable by hand alone now that the orbit is gone, and whether spreading covers distance steadily instead of stalling
