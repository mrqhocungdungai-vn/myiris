...
- [ ] 10.10 Manual pass on the new model: whether aiming at a note and spreading actually arrives at it, whether the far side of the sphere is still reachable by hand alone now that the orbit is gone, and whether spreading covers distance steadily instead of stalling
