...
- **THEN** the thinking swirl, wake pulse, speech-lock ripple, task flashes and state palette all behave identically — only the means of drawing the glow differs
