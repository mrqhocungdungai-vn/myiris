...
Governs the renderer's Gemini audio output lifecycle: how interruptions (barge-in / flush) cancel in-flight and playing audio, and how the output audio device is acquired and released across session stop/start.
