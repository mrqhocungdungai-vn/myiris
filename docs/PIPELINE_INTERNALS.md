...
- Nothing is installed into `~/.claude`. Older Iris versions did copy skills, commands, and personas there; Settings offers a one-click removal of exactly those paths and nothing else.
