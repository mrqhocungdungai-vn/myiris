...
// left mounted (and interactivity-latching, or for the second brain snapping
// back on) the next time the HUD is entered.

export type HudLayer = "drawing" | "secondBrain" | null;
...
export function isSecondBrain(layer: HudLayer): boolean {
  return layer === "secondBrain";
}
